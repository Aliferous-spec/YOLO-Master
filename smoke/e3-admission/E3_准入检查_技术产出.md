...
5. **实测结果**：运行 `scripts/measure_routing_hook_overhead.py`（yolo-master-n @ 640×640，50 次前向）：关 hook 77.6 ms/次，开 hook 78.7 ms/次，额外开销 **1.50%**，满足 < 10% 目标
